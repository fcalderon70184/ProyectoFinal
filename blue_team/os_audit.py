...
"""
Este script ejecuta una auditoría del sistema con información de usuarios, grupos,
puertos, servicios y configuraciones críticas.
"""
...
class SystemAudit:
    ...
    def run_audit(self):
        #Ejecuta todas las comprobaciones del sistema.
        try:
    ...
    def _run(self, cmd, check=False):
        #Ejecuta un comando en subprocess y devuelve la salida
    ...
    def _running_services(self):
        ...
        #Ver procesos y servicios en ejecución
        try:
    ...
    def _check_config_files(self):
        ...
        #Ver configuraciones sensibles del sistema
...
if __name__ == "__main__":
    # Crear un reporte de auditoría en el archivo
    log_path = "/home/Adminluis/blue_team/os_audit_report.log"
    with open(log_path, "w") as log_file:
        sys.stdout = log_file
        sys.stderr = log_file
        SystemAudit().run_audit()
    sys.stdout = sys.__stdout__
    print("[INFO] Auditoría completada. Reporte guardado")
